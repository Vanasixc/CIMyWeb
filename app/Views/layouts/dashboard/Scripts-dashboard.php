...
<script src="https://cdn.datatables.net/2.0.7/js/dataTables.bootstrap5.min.js"></script> <script>
    $(document).ready(function() {
        $('#myTable').DataTable({
            "processing": true,     // Menampilkan indikator "loading"
            "serverSide": true,     // Mengaktifkan mode server-side
            "ajax": {
                // URL yang akan dihubungi untuk mengambil data JSON
            ...
            "columns": [
                ...
                // Kolom untuk data dari database
                { "data": "id", "className": "text-center" },
                { "data": "nama", "className": "text-center" },
                { "data": "username", "className": "text-center" }
            ],
            // Fungsi untuk membuat nomor urut otomatis
            "order": [[1, 'asc']], // Default sorting berdasarkan kolom ID
